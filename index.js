...
function displayTitle(){
    var  curWeek = '9.14.2025 - 9.20.2025';
...
function displayMorningRevival(){
    ...
    const chapter = "第五周 保守自己在主工作的一道流中，为着召会的扩展，并且受主怜悯蒙拯救脱离撒但的诡计"
...
function displayBible(){
    ...
    const old_test = "申命记";
    const old_test_cov = "第31~34章"
    const old_test1 = "约书亚记";
    const old_test_cov1 = "第1章"
    const old_test_link = curWeekLink;
    const new_test = "帖撒罗尼迦前书";
    const new_test_cov = "第2~5章";
    const new_test1 = "帖撒罗尼迦后书";
