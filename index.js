...
function displayTitle(){
    var  curWeek = '7.20.2025 - 7.26.2025';
...
function displayMorningRevival(){
    ...
    const book = '2025年国际华语特会 罗马书五至八章—圣经的核仁';
    const chapter = "第二周 我们蒙称义的结果—在作我们生命的基督里完满地享受神"
...
function displayBible(){
    ...
    const old_test = "民数记";
    const old_test_cov = "第27~31章"
    const old_test_link = curWeekLink;
    const new_test = "哥林多前书";
    const new_test_cov = "第11~15章";
