...
function displayTitle(){
    var  curWeek = '9.28.2025 - 10.04.2025';
...
function displayMorningRevival(){
    ...
    const chapter = "第七周 在使徒行传的继续里，持续在人类历史中活在神圣历史里，为着扩展并建造召会，作基督团体的显现"
...
function displayBible(){
    ...
    const old_test = "约书亚记";
    const old_test_cov = "第7~11章"
    const old_test_link = curWeekLink;
    const new_test = "提摩太前书";
    const new_test_cov = "第4~6章";
    const new_test1 = "提摩太后书";
    const new_test_cov1 = "第1~2章";
